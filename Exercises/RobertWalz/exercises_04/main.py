...
from util import evaluate_opcode, get_refs
...
def main():
    ...
    while computer_instance.instruction_pointer < len(commands) and computer_instance.instruction_pointer is not None:
        evaluate_opcode(opcode=computer_instance.commands[computer_instance.instruction_pointer], computer_instance=computer_instance)
