...
def computerSim():
    for counter in range(0,int(len(commands)),4):   #going through every block of 4 elements
        #print(f'checking the {counter} element')#troubleshooting
        match commands[counter]:
            case 1: #addition
                #print(f'detected operator 1')#troubleshooting
                sum = (commands[counter+1] + commands[counter+2])
                placeToInsert = commands[counter+3]
                commands[placeToInsert] = sum
            case 2: #multiplication
                #print(f'detected operator 2')#troubleshooting
                prod = (commands[counter+1] * commands[counter+2])
                placeToInsert = commands[counter+3]
                commands[placeToInsert] = prod
            case 99:    #halt
...
print(computerSim()) #execute the function and print the return statement
