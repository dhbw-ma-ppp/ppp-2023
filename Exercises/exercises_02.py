...
def sim_computer(opcode):
    ...
    return opcode[0] # Return Value at 0th position in list 
...
# Seperating input with split function, then using "*" to unpack list and pass element as seperate arguments
# because a normal list will be treated like a single argument