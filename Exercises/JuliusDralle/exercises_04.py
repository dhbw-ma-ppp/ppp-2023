...
def save_at(*args):
    print("save_at ausgeführt", args)
    return 0

def output(*args):
    print("output ausgeführt", args)
    return 0

def jump_if_true(*args):
    print("jump_if_true ausgeführt", args)
    return 0

def jump_if_false(*args):
    print("jump_if_false ausgeführt", args)
    return 0

def less_than(*args):
    print("less_than ausgeführt", args)
    return 0

def equals(*args):
    print("equals ausgeführt", args)
    return 0
